...
const Page04 = ({ page4Data, page44Data, page444Data }) => {
  ...
  const produceArray = () => {
    ...
    if (page444Data) {
      ...
      let secondLine =
        "The experiences we imagine are made for everyone. Everyone. You. Your mom, your dad. Your brothers and sisters. Your friends and colleagues.";
      let thirdLine =
        " Everyone with a bit of imagination, curiosity and the desire to open and explore new worlds.";
      if (firstLine) {
        let arrayWords = firstLine.replace(/"/g, "").split(" ");
