...
const schema = yup.object().shape({
    ...
    contributorRole: yup.string().required('missing field'),
                ...
                <div className={styles.content2Edit}>
                    ...
                    <div className={styles.row1}>
                        {new Array(5).fill(0).map((_, idx) => {
                            return (
                                <div key={idx} className={styles.titleEdit}>
                                    <h3>Image {idx + 1} : </h3>
                                    <input
                                        type="file"
                                        accept="image/*"
                                        ...
                                        onChange={(e) => {
                                            ...
                                            setDidNotSubmitHeadForm2(true);
                                            setDidNotSubmitHeadForm(true);
                                            if (idx === 0) handleChangeFile(e, setImg2)
                                            if (idx === 1) handleChangeFile(e, setImg3)
                                            if (idx === 2) handleChangeFile(e, setImg4)
                                            if (idx === 3) handleChangeFile(e, setImg5)
                                            if (idx === 4) handleChangeFile(e, setImg6)
                                        }}
                                    />
                                    {
                                        idx === 0 && img2 && <>
